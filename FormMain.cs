...
namespace FordsAlgorithm
{
    public partial class FormMain : Form
    {
        ...
        private void buttonНайтиПуть_Click(object sender, EventArgs e)
        {
            ...
            ЗаписатьВконсоль(УправлениеГрафами.ТекущийГраф.ОпределитьКороткийПуть(Convert.ToInt32(comboBox1.Text), Convert.ToInt32(comboBox2.Text)));
        }
